...
function extra_user_profile_fields( $user ) { ?>
    ...
    <tr>
        <th><label for="googleplus"><?php esc_html_e('Googleplus','avas-core'); ?></label></th>
        <td>
            ...
            <span class="description"><?php esc_html_e('Please enter your Googleplus url.','avas-core'); ?></span>
        </td>
    </tr>
    <tr>
