...
class BDDEX_Stats_Bars_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __('Avas Stats Bars', 'avas-core');
    }
    ...
    protected function _register_controls() {
            ...
            [
                ...
                'fields' => [
                    [
                        ...
                        'description' => __('The title for the stats bar', 'avas-core'),
                    ],
        ...
        $this->add_control(
            'stats_bar_bg_color',
            [
                'label' => __('Stats Bar Background Color', 'avas-core'),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'stats_bar_spacing',
            [
                'label' => __('Stats Bar Spacing', 'avas-core'),
        ...
        $this->add_control(
            'stats_bar_height',
            [
                'label' => __('Stats Bar Height', 'avas-core'),
                'type' => Controls_Manager::SLIDER,
                'size_units' => ['px'],
                'default' => [
                    'size' => 10,
        ...
        $this->add_control(
            ...
            [
                'label' => __('Stats Bar Border Radius', 'avas-core'),
        ...
        $this->add_control(
            ...
            [
                'label' => __('Spacing from Stats Title', 'avas-core'),
                'type' => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', '%', 'em'],
                'default' => [
                    'top' => 0,
...
Plugin::instance()->widgets_manager->register_widget_type( new BDDEX_Stats_Bars_Widget() );