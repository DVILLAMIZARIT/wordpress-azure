...
class LP_Carousel extends Widget_Base {
    ...
    public function get_name() {
        return 'bddex-lp-carousel';
    }

    public function get_title() {
        return esc_html__('Avas Course Carousel', 'avas-core');
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'default'           => '|',
                'selectors'         => [
                    '{{WRAPPER}} .edu-entry-info .author:after' => 'content: "{{UNIT}}";',
                ],
                'condition'         => [
                    'display_author' => 'yes',
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units'        => [ 'px', 'em', '%' ],
                'selectors'         => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units'        => [ 'px', 'em', '%' ],
                'selectors'         => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .hentry' => 'margin: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 10,
                'selectors' => [
                    '(tablet-){{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item' => 'padding: {{VALUE}}px;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 10,
                'selectors' => [
                    '(mobile-){{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item' => 'padding: {{VALUE}}px;',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-project-image .edu-image-overlay' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-project-image .edu-image-overlay' => 'opacity: {{SIZE}};',
                ],
            ]
        );
         $this->end_controls_section();
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector'          => '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-project-image .edu-image-info .edu-entry-info,.edu-lp-carousel .edu-lp-carousel-item .edu-entry-text-wrap',
            ]
        );
        $this->add_control(
            'p_c_c_padding',
            [
                ...
                'size_units'        => [ 'px', 'em', '%' ],
                'selectors'         => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-project-image .edu-image-info .edu-entry-info' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .post-carousel-overlay .edu-entry-info' => 'text-align: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .edu-lp-carousel-item',
            ]
        );
        $this->end_controls_section();
        $this->start_controls_section(
        ...
        $this->add_control(
            'edu_price_bg_color',
            [
                'label' => esc_html__( 'Price BG Color', 'avas-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-course-price' => 'background: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-course-price .price' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            'edu_orig_price_color',
            [
                'label' => esc_html__( 'Original Price Color', 'avas-core' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-course-price .origin-price' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_group_control(
            ...
            [
                'name' => 'edu_price_typography',
                'selector' => '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-course-price .price, .edu-lp-carousel .edu-lp-carousel-item .edu-course-price .origin-price',
            ]
        );
        $this->add_responsive_control(
            'edu_price_position',
            [
                'label' => esc_html__( 'Position Vertical', 'avas-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 142,
                    'unit' => 'px',
                ...
                'selectors' => [
                    '{{WRAPPER}} .edu-course-price' => 'bottom: {{SIZE}}px;',
                ],
            ]
        );
        $this->add_responsive_control(
            'edu_price_position_horizontal',
            [
                'label' => esc_html__( 'Position Horizontal', 'avas-core' ),
                'type' => Controls_Manager::SLIDER,
                'default' => [
                    'size' => 0,
                    'unit' => 'px',
                ...
                'selectors' => [
                    '{{WRAPPER}} .edu-course-price' => 'left: {{SIZE}}px;',
                ],
            ]
        );
        $this->end_controls_section();
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .entry-title a' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .entry-title a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        $this->add_control(
            ...
            [
                ...
                'size_units'        => [ 'px', 'em', '%' ],
                'selectors'         => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .entry-title' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition'         => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .entry-title',
            ]
        );
        $this->add_responsive_control(
            'title_align',
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .edu-entry-info .entry-title' => 'text-align: {{VALUE}};',
                ],
                'condition'         => [
                    'display_taxonomy'     => 'yes',
                    'bddex_post_block_grid_style'    => 'post-block-style-overlay'
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .entry-summary' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .entry-summary',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'         => [
                    '{{WRAPPER}} .edu-entry-info .edu-terms a' => 'background: {{VALUE}}',
                ],
                'condition'         => [
                    'display_taxonomy'     => 'yes',
                    'bddex_post_block_grid_style'    => 'post-block-style-overlay'
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'         => [
                    '{{WRAPPER}} .edu-entry-info .edu-terms a:hover' => 'background: {{VALUE}}',
                ],
                'condition'         => [
                    'display_taxonomy'     => 'yes',
                    'bddex_post_block_grid_style'    => 'post-block-style-overlay'
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'         => [
                    '{{WRAPPER}} .edu-entry-info .edu-terms a' => 'color: {{VALUE}}',
                ],
                'condition'         => [
                    'display_taxonomy'     => 'yes',
                    'bddex_post_block_grid_style'    => 'post-block-style-overlay'
        ...
        $this->add_control(
            ...
            [
                ...
                'selectors'         => [
                    '{{WRAPPER}} .edu-entry-info .edu-terms a:hover' => 'color: {{VALUE}}',
                ],
                'condition'         => [
                    'display_taxonomy'     => 'yes',
                    'bddex_post_block_grid_style'    => 'post-block-style-overlay'
        ...
        $this->add_control(
            ...
            [
                ...
                'size_units'        => [ 'px', 'em', '%' ],
                'selectors'         => [
                    '{{WRAPPER}} .edu-entry-info .edu-terms a' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
                'condition'         => [
                    'display_taxonomy'     => 'yes',
                    'bddex_post_block_grid_style'    => 'post-block-style-overlay'
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .edu-entry-meta span, .edu-image-info span' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .course-cateogory a',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .course-cateogory a' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'type' => Controls_Manager::COLOR,
                'selectors' => [
                    '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .course-cateogory a:hover' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .edu-lp-carousel .edu-lp-carousel-item .author-link, .published',
            ]
        );
        $this->add_responsive_control(
            'meta_align',
            [
                ...
                'default'   => '',
                'selectors' => [
                    '{{WRAPPER}} .edu-entry-info .edu-terms,.author-date' => 'text-align: {{VALUE}};',
                ],
                'condition'         => [
                    'display_taxonomy'     => 'yes',
                    'display_author' => 'yes',
    ...
    protected function render() {
        ...
        if ($loop->have_posts()) : ?>
            ...
            <div id="edu-lp-carousel-<?php echo uniqid(); ?>"
                 class="edu-lp-carousel edu-container"
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <?php if ($thumbnail_exists = has_post_thumbnail()): ?>
                                ...
                                <div class="edu-project-image">
                                    ...
                                    <!-- <div class="edu-image-overlay"></div> -->
                                    <div class="edu-course-price">
                            ...
                            <?php if (($settings['display_title'] == 'yes') || ($settings['display_summary'] == 'yes')) : ?>
                                ...
                                <div class="edu-entry-text-wrap <?php echo($thumbnail_exists ? '' : ' nothumbnail'); ?>">
                                ...
                                <div class="edu-course-footer">
                                    <?php echo bddex_lp_author(); ?>
                                    <?php echo bddex_lp_rating(); ?>
                                    <?php echo bddex_lp_student_endrolled(); ?>
                                    <?php echo '<div class="lp_post_views">'.bddex_getPostViews(get_the_ID()).'</div>'; ?>
                                </div>
                        ...
                        <div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                            ...
                            <?php if ($thumbnail_exists = has_post_thumbnail()): ?>
                                ...
                                <div class="edu-project-image">
                                    ...
                                    <div class="edu-image-info post-carousel-overlay">
...
Plugin::instance()->widgets_manager->register_widget_type( new LP_Carousel() );