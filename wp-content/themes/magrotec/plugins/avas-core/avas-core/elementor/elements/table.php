...
class Bddex_Table extends Widget_Base {
   ...
   public function get_categories() {
	...
	protected function _register_controls() {
			...
			[
				...
				'fields' => [
					[
						...
						'label' => esc_html__( 'Column Name', 'avas-core' ),
					...
					[
						...
						'label' => esc_html__( 'Column Span', 'avas-core' ),
						'default' => '',
						'type' => Controls_Manager::TEXT,
						'label_block' => false,
					],
					[
						...
						'label' => esc_html__( 'Enable Header Icon', 'avas-core' ),
					...
					[
						...
						'label'	=> esc_html__( 'Header Icon Type', 'avas-core' ),
					...
					[
						...
						'label' => esc_html__( 'Image Size(px)', 'avas-core' ),
						'default' => '25',
					...
					[
						...
						'label'			=> esc_html__( 'CSS Class', 'avas-core' ),
						'type'			=> Controls_Manager::TEXT,
						'label_block' 	=> false,
					],
					[
						'name'			=> 'eael_data_table_header_css_id',
						'label'			=> esc_html__( 'CSS ID', 'avas-core' ),
						'type'			=> Controls_Manager::TEXT,
						'label_block'	=> false,
					],
			...
			[
				...
				'fields' => [
					[
						...
						'label' => esc_html__( 'Row Type', 'avas-core' ),
					...
					[
						...
						'options'               => [
							'textarea'        => [
								'title'   => esc_html__( 'Textarea', 'avas-core' ),
								'icon'    => 'fa fa-text-width',
							],
							'editor'       => [
								'title'   => esc_html__( 'Editor', 'avas-core' ),
								'icon'    => 'fa fa-pencil',
							],
							'template'        => [
								'title'   => esc_html__( 'Templates', 'avas-core' ),
								'icon'    => 'fa fa-file',
							]
						],
						'default'	=> 'textarea',
					...
					[
		                ...
		                'label'                 => __( 'Choose Template', 'avas-core' ),
		                'type'                  => Controls_Manager::SELECT,
		                'options'               => bddex_get_page_templates(),
						'condition'             => [
					...
					[
						...
						'label' => esc_html__( 'Cell Text', 'avas-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'General Style', 'avas-core' ),
		...
		$this->start_controls_tabs('eael_data_table_header_title_clrbg');
			...
			$this->start_controls_tab( 'eael_data_table_header_title_normal', [ 'label' => esc_html__( 'Normal', 'avas-core' ) ] );
			...
			$this->start_controls_tab( 'eael_data_table_header_title_hover', [ 'label' => esc_html__( 'Hover', 'avas-core' ) ] );
		...
		$this->start_controls_tabs('eael_data_table_content_row_cell_styles');
			...
			$this->start_controls_tab('eael_data_table_odd_cell_style', ['label' => esc_html__( 'Normal', 'avas')]);

				$this->add_control(
					'eael_data_table_content_odd_style_heading',
					[
						'label' => esc_html__( 'ODD Cell', 'avas-core' ),
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Color ( Odd Row )', 'avas-core' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#6d7882',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Background ( Odd Row )', 'avas-core' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#f2f2f2',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Even Cell', 'avas-core' ),
						'type' => Controls_Manager::HEADING,
					]
				);
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Color ( Even Row )', 'avas-core' ),
						'type' => Controls_Manager::COLOR,
						'default' => '#6d7882',
						'selectors' => [
				...
				$this->add_control(
					...
					[
						'label' => esc_html__( 'Background Color (Even Row)', 'avas-core' ),
						'type' => Controls_Manager::COLOR,
						'default' => '',
						'selectors' => [
			...
			$this->start_controls_tab('eael_data_table_odd_cell_hover_style', ['label' => esc_html__( 'Hover', 'avas')]);
		...
		$this->start_controls_tabs( 'eael_data_table_link_tabs' );
			...
			// Normal State Tab
			$this->start_controls_tab( 'eael_data_table_link_normal', [ 'label' => esc_html__( 'Normal', 'avas-core' ) ] );
			...
			// Hover State Tab
			$this->start_controls_tab( 'eael_data_table_link_hover', [ 'label' => esc_html__( 'Hover', 'avas-core' ) ] );
		...
		$this->start_controls_section(
			...
			[
				'label'		=> esc_html__( 'Responsive Header Styles', 'avas-core' ),
			    ...
			    <thead>
			        <tr class="table-header">
			            ...
			            <th <?php echo $this->get_render_attribute_string('th_class'.$i); ?>>
							...
							?><img <?php echo $this->get_render_attribute_string('data_table_th_img'.$i); ?>><?php endif; ?><?php echo __( $header_title['eael_data_table_header_col'], 'avas-core' ); ?></th>
			        	<?php $i++; endforeach; ?>
			        </tr>
			    </thead>
			  	<tbody>
...
Plugin::instance()->widgets_manager->register_widget_type( new Bddex_Table() );