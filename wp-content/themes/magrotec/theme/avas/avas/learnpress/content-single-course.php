...
<div class="course-thumbnail">
 ...
 global $post;
 $image = get_post_meta($post->ID, 'bddex_gallery_id', true);
	...
	<ul id="course-gallery" class="gallery list-unstyled cS-hidden">
        ...
        if($images) :
    	    foreach ($images as $img) {
                ...
                $gallery = wp_get_attachment_link($img, 'single_course_image');
...
bddex_course_info();
 ...
 //  require_once THEME_PATH . '/learnpress/rate.php';
?>

</div><!-- sidebar -->
<?php bddex_related_courses(); ?>
