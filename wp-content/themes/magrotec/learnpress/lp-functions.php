...
if ( ! function_exists( 'bddex_remove_lp_price' ) ) {
	add_action('after_setup_theme', 'bddex_remove_lp_price' );
	function bddex_remove_lp_price(){
 ...
 * Display course info
 */
if ( ! function_exists( 'bddex_course_info' ) ) {
  function bddex_course_info() {
    ...
    <div class="lp-course-features">
      ...
      <ul>
        <li class="lectures-feature">
          ...
          <span class="value"><?php echo wp_kses_post($course->get_curriculum_items( 'lp_lesson' )) ? count( $course->get_curriculum_items( 'lp_lesson' ) ) : 0; ?></span>
        </li>
        <li class="quizzes-feature">
          <i class="fa fa-puzzle-piece"></i>
          <span class="label"><?php esc_html_e( 'Quizzes', 'avas' ); ?></span>
          <span class="value"><?php echo wp_kses_post($course->get_curriculum_items( 'lp_quiz' )) ? count( $course->get_curriculum_items( 'lp_quiz' ) ) : 0; ?></span>
        </li>
 ...
 */
if ( ! function_exists( 'bddex_related_courses' ) ) {
  function bddex_related_courses() {
    $related_courses    = bddex_get_related_courses( 5 );
?>
...
if ( ! function_exists( 'bddex_get_related_courses' ) ) {
  function bddex_get_related_courses( $limit ) {
    if ( ! $limit ) {
      $limit = 6;
    }
    $course_id = get_the_ID();
...
function bddex_lp_student_endrolled() {
global $course;
